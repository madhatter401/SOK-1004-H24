...
df %>% 
  ...
  theme_minimal()+
  labs(x = "Milliarder kroner", y = "Antall observasjoner", title = "Totale FoU Kostnadder 2015-2020", fill = "Antall ansatte")
